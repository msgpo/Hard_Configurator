...
$RegDataFull  &= '' & 'XBAP' & @LF & 'XLA' & @LF & 'XLAM' & @LF & 'XLB' & @LF & 'XLC' & @LF & 'XLD' & @LF & 'XLL' & @LF & 'XLM' & @LF & 'XLSB' & @LF & 'XLSM' & @LF & 'XLT' & @LF & 'XLTM' & @LF & 'XLTX' & @LF & 'XLW' & @LF & 'XML' & @LF & 'XNK' & @LF & 'XPI' & @LF & 'XPS' & @LF & 'Z' & @LF & 'ZFSENDTOTARGET' & @LF & 'ZLO' & @LF & 'ZOO'
