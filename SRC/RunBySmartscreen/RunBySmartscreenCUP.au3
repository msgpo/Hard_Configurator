...
#AutoIt3Wrapper_Res_LegalCopyright=Copyright *  Andy Ful , October 2018
...
If $IsSmartScreenEnabled = 0 Then
   _ExtMsgBox(0,"&OK", "Run By SmartScreen", "The SmartScreen is disabled. Please enable it to make use of 'Run By Smartscreen'. ")
   Exit
EndIf
...
If $FileExt = ".msi" Then
   ShellExecute("msiexec.exe","/i " & chr(34) & $CmdLine[1] & chr(34),$FileDrive & $FilePath)   
   Exit
EndIf
