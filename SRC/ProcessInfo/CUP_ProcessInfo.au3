...
Global $LogFilePath = $systemdrive & '\ProgramData\CasualUserProtection\'
Local $command = ""
Local $command0 = ""
Local $temp
Local $sponsor
...
If not (FileExists($LogFilePath) = 1) Then
...
;   MsgBox(0,"interpreter", $scriptsponsor)
   ...
   IsLogBackupNeeded()
   FileWrite($LogFilePath & "ProcessInfo.log", "Grand-Parent process: " & $ggpf & @crlf & @crlf & "Parent process: " & $gpf & @crlf & @crlf & "The initial command line: " & $gpcl & @crlf & @crlf & "Script path: " & $scriptPath & @crlf & @crlf & "Interpreter path: " & $scriptsponsor & $ExeExtension & @crlf & @crlf & "commandline: " & $command & @crlf & @crlf & "*****************************************" & @crlf & @crlf & @crlf)
...
;           MsgBox(0,"From Script","Initial commandline: " & $command & @crlf & @crlf & "Script path: " & $scriptPath & @crlf & @crlf & "Final commandline: " & $commandScript & @crlf & @crlf & "Interpreter path: " & $scriptsponsor)
           MsgBox(0,"CUP","Action blocked by Casual User Protection.")
...
Func IsLogBackupNeeded()
Local $LogSize = FileGetSize($LogFilePath & "ProcessInfo.log")
If $LogSize > 512000 Then
   FileDelete($LogFilePath & "ProcessInfoOld.log")
   FileCopy($LogFilePath & "ProcessInfo.log", $LogFilePath & "ProcessInfoOld.log")
   FileDelete($LogFilePath & "ProcessInfo.log")
EndIf
EndFunc