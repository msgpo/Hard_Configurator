...
;   GUICtrlSetOnEvent(-1, "HelpSMB") 
   ...
   $BtnDisableCachedLogons = GUICtrlCreateButton("Disable Cached Logons", 117+$deltaX, 149-19-19, 140, 19)
   GUICtrlSetOnEvent(-1, "DisableCachedLogons1")
   $BtnHelpDisableCachedLogons = GUICtrlCreateButton("Help", 260+$deltaX, 149-19-19, 40, 19)
   GUICtrlSetOnEvent(-1, "HelpDisableCachedLogons") 

   $BtnUAC_CTRL_ALT_DEL = GUICtrlCreateButton("UAC CTRL_ALT_DEL", 117+$deltaX, 168-19-19, 140, 19)
   GUICtrlSetOnEvent(-1, "UAC_CTRL_ALT_DEL1")
   $BtnHelpUAC_CTRL_ALT_DEL = GUICtrlCreateButton("Help", 260+$deltaX, 168-19-19, 40, 19)
