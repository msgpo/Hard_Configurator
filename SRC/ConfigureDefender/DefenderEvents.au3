...
Local $command = "wevtutil qe " & '"Microsoft-Windows-Windows Defender/Operational"' & " /q:" & chr(34) & "*[System[Provider[@Name='Microsoft-Windows-Windows Defender']  and (EventID=1006 or EventID=1008 or EventID=1015 or EventID=1116 or EventID=1117 or EventID=1118 or EventID=1119 or EventID=1121 or EventID=1122 or EventID=1123 or EventID=1124 or EventID=1125 or EventID=1126 or EventID=1127 or EventID=1128 or EventID=3002 or EventID=5001 or EventID=5004 or EventID=5007 or EventID=5008 or EventID=5010 or EventID=5012)]]" & chr(34) & " /c:200 /f:text /rd:true"
;MsgBox(0,"",$command)
