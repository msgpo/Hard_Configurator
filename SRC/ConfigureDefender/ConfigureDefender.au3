...
#AutoIt3Wrapper_Res_LegalCopyright=Andy Ful, April 2019
...
; Default Defender settings
    ...
    GUICtrlSetFont ( $BtnDefaultDefenderSettings, 10)
    GUICtrlSetBkColor(-1,0xeaeaea)
...
; Defender High Settings
    ...
    GUICtrlSetFont ( $BtnDefenderHighSettings, 10)
    GUICtrlSetBkColor(-1,0xeaeaea)
...
; Child Protection
    ...
    GUICtrlSetFont ($BtnDefenderChildProtection, 10)
    GUICtrlSetBkColor(-1,0xeaeaea)
...
;    MsgBox(0,"",$ActualSetting)
    ...
    GUICtrlSetFont (-1, 10, 600)
    Local $LabelHideSecurityCenter=GUICtrlCreateLabel ("ADMIN:  HIDE  SECURITY  CENTER", 20, 700+$dx+$dy+$dz+$dr, 350, 16, $SS_LEFT)
;    GUICtrlSetFont ($LabelHideSecurityCenter, 10)
    GUICtrlSetFont ($LabelHideSecurityCenter, 10, 600)
    $idComboBoxHideSecurityCenter = GUICtrlCreateCombo("Visible", 300+$dp, 700+$dx+$dy+$dz+$dr, 80, 20)
    GUICtrlSetBkColor(-1,0xf8f8f8)
...
_ExtMsgBoxSet(1+4+8+32, 0, -1, -1, 10, "Arial", @DesktopWidth*0.7)
Local $x = _ExtMsgBox(0,"&CLOSE|NEXT|BACK", "ConfigureDefender HELP", $help1)
If $x < 2 Then Return
If $x = 2 Then Help2()
...
_ExtMsgBoxSet(1+4+8+32, 0, -1, -1, 10, "Arial", @DesktopWidth*0.7)
Local $x = _ExtMsgBox(0,"&CLOSE|NEXT|BACK", "ConfigureDefender HELP", $help2)
If $x < 2 Then Return
If $x = 2 Then Help3()
If $x > 2 Then Help1()
EndFunc
...
;   $help = FileRead(@ScriptDir & "\ConfigureDefenderHelp1.txt")
   _ExtMsgBoxSet(1+4+8+32, 0, -1, -1, 10, "Arial", @DesktopWidth*0.7)
   Local $x = _ExtMsgBox(0,"&CLOSE|BACK", "ConfigureDefender HELP", $help3)
If $x < 2 Then Return
If $x >= 2 Then Help2()
EndFunc
